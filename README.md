# 🍯 MINTSQUARE - AI Honeypot for Scam Detection
...
- ✅ API key authentication (hp_* prefix)
- ✅ Input validation and sanitization
- ✅ Rate limiting (100 requests/hour per key)
- ✅ Auto-managed secrets (no manual configuration)
- ✅ HTTPS-only endpoints
- ✅ No sensitive data in logs

## 📈 Performance Optimization

- **Multi-layer Detection**: Fast keyword check → Pattern matching → AI analysis
...
curl -X POST https://vfqfcfqgwuntrqcqcbyv.supabase.co/functions/v1/honeypot-detect \
  -H "x-api-key: hp_test_key_12345abcdef67890xyz" \
  -H "Content-Type: application/json" \
  -d '{"sessionId":"test-1","message":{"sender":"scammer","text":"Send ₹500 to 9876543210","timestamp":1770005528731},"conversationHistory":[]}'
```
...
2. **Conversation Strategy**: Stage-based questioning (concern → verification → compliance → obstacles) maximizes intelligence extraction
